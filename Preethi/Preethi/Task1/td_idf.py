...
def tf_idf_run(folder):
    ...
    with open(queries_file, 'r') as query_file_obj:
        ...
        for tag in cleantext.findAll('doc'):
            ...
            rank = 1
            with open(folder+"\\Query_"+str(query_cnt)+".txt",'a') as tf_idf_output:
...
try:
    shutil.rmtree("tf_idf_scoring_base")
except:
    pass
os.getcwd()
os.mkdir("tf_idf_scoring_base")

loadindex()
tf_idf_run("tf_idf_scoring_base")